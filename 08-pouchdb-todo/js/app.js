(function() {
  ...
  // listener que indica cambio a la base datos
  ...
  function addTodo(text) {
    ...
    // insert in indexDB (promise form)
    db.put(todo)
      .then(console.log('Successfully posted a todo!'))
      .catch(console.error);

    /* insert in indexDB (callback form)
  ...
  function deleteButtonPressed(todo) {
    db.remove(todo)
      .then(console.log('tarea removida'))
      .catch(console.error);
  }
